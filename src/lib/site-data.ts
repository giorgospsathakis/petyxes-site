...
export const offerings = [
  ...
  },
  {
    ...
    text: "Φιλικό περιβάλλον μελέτης με επίβλεψη, ώστε κάθε μαθητής να αξιοποιεί τον χρόνο του αποδοτικά.",
    image: serviceStudy,
  },
  {
    icon: Lightbulb,
  ...
  },
  {
    ...
    text: "Τακτικές προσομοιώσεις, αναλυτική βαθμολόγηση και στοχευμένη προετοιμασία για εξετάσεις.",
    image: serviceClassroom,
  },
  {
    icon: Users,
...
export const courseGroups = [
  {
    title: "Γυμνάσιο",
    subjects: ["Μαθηματικά", "Φυσική — Χημεία", "Αρχαία & Νέα Ελληνικά", "Αγγλικά", "Ιστορία"],
    text: "Σταθερές βάσεις, μεθοδική μελέτη και συνέπεια στην καθημερινή προετοιμασία.",
  },
  {
    title: "Λύκειο (Α΄ & Β΄)",
    subjects: ["Άλγεβρα & Γεωμετρία", "Φυσική — Χημεία", "Έκθεση — Λογοτεχνία", "Αρχαία", "Πληροφορική"],
    text: "Ενίσχυση σε όλα τα μαθήματα και έγκαιρη εξοικείωση με τον προσανατολισμό.",
  },
  {
    title: "Γ΄ Λυκείου — Πανελλαδικές",
