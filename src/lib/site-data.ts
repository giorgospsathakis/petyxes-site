...
export const offerings = [
  ...
  },
  {
    ...
    text: "Φιλικό περιβάλλον μελέτης με επίβλεψη, για παιδιά Δημοτικού, Γυμνασίου και Λυκείου, ώστε κάθε μαθητής να αξιοποιεί τον χρόνο του αποδοτικά.",
    image: serviceStudy,
  },
  {
    icon: Lightbulb,
  ...
  },
  {
    ...
    text: "Τακτικές προσομοιώσεις, συμμετοχή στα διαγωνίσματα ΟΕΦΕ — είμαστε μέσα!, αναλυτική βαθμολόγηση και στοχευμένη προετοιμασία για εξετάσεις.",
    image: serviceClassroom,
  },
  {
    icon: Users,
